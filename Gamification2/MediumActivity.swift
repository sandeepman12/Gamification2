...
class MediumActivityViewController: UIViewController, UITextFieldDelegate, UITableViewDataSource
{
    @IBOutlet weak var field: UITextField!
    @IBOutlet weak var tableView: UITableView!
    
    //an array to hold the "MediumActivity" ENITTY
    var gameNameArray:[MediumActivity] = []
    ...
    @IBAction func addButton(_ sender: Any)
    {
        ...
        if field.text != ""
        {
            ...
            let newActivity = NSEntityDescription.insertNewObject(forEntityName: "MediumActivity", into: context)
            
            //sets the attributes in the "Gamification2.xcdatamodeld" for the "MediumActivity" ENTITY
            /*
            ...
            //reloads the tableView to see the latest results
    ...
    func fetchData()
    {
        ...
        do {
            gameNameArray = try context.fetch(MediumActivity.fetchRequest())
        } catch {
            print(error)
        }
    }
